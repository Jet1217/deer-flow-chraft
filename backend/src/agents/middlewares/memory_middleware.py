...
class MemoryMiddleware(AgentMiddleware[MemoryMiddlewareState]):
    ...
    def __init__(self, agent_name: str | None = None, user_id: str | None = None):
        ...
        Args:
            ...
            user_id: The authenticated user ID for multi-tenant memory isolation.
        """
        super().__init__()
    ...
    def after_agent(self, state: MemoryMiddlewareState, runtime: Runtime) -> dict | None:
        ...
        queue.add(thread_id=thread_id, messages=filtered_messages, agent_name=self._agent_name, user_id=self._user_id)
