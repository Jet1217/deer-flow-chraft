...
async def get_artifact(thread_id: str, path: str, request: Request, user_id: str = Depends(get_current_user_id)) -> FileResponse:
    ...
    """
    # Verify thread ownership before serving any artifact
