...
export function WorkspaceHeader({
  ...
  return (
    <header
      className={cn(
        "top-0 right-0 left-0 z-20 flex h-12 shrink-0 items-center gap-2 border-b transition-[width,height] ease-out group-has-data-[collapsible=icon]/sidebar-wrapper:h-12",
        className,
      )}
      {...props}
    >
