...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 🦌 Chraft，一个完全开源的超级智能体。通过内置和自定义的 Skills，\nChraft 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 Chraft 的潜力。通过自定义技能，Chraft\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 Chraft 官方网站",
    githubTooltip: "访问 Chraft 的 Github 仓库",
    settingsAndMore: "设置",
    visitGithub: "在 Github 上查看 Chraft",
    reportIssue: "报告问题",
    contactUs: "反馈",
    about: "关于 Chraft",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 Chraft 中使用",
  },
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 Chraft 的界面和行为。",
    sections: {
      appearance: "外观",
      memory: "记忆",
      tools: "工具",
    ...
    agents: {
      title: "智能体",
      description: "查看和管理你的自定义智能体，发起新对话或删除不再需要的智能体。",
    },
    memory: {
      title: "记忆",
      description:
        "Chraft 会在后台不断从你的对话中自动学习。这些记忆能帮助 Chraft 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      markdown: {
        overview: "概览",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 Chraft 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "Chraft 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
